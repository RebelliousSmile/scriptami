  ...
  return (
    <nav className="flex justify-center py-4">
      <ul className="flex flex-wrap items-center justify-center gap-x-6 gap-y-1 text-sm font-medium text-zinc-800 dark:text-zinc-200">
        ...
        <li><Link href="/services" className="transition hover:text-teal-500 dark:hover:text-teal-400">Services</Link></li>
        <li><Link href="/thoughts" className="transition hover:text-teal-500 dark:hover:text-teal-400">Microblog</Link></li>
