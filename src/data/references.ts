...
export const references: Reference[] = [
  ...
  },
  {
    ...
    description: "Pour cette boutique en phase d'ascension, il est crucial d'éliminer les écueils amoncelés en chemin avant la prochaine montée en charge. Stabiliser le dialogue entre la boutique et l'ERP, s'assurer de la compatibilité du code pour les prochaines mises à jour, veiller à ne pas se fermer des portes avec des achats de module précipités. J'interviens dans les mises à jour et les développements de cette boutique Prestashop 1.7/8.",
    event: 'Epicime',
